...
function constructSaveState() {
  const character = {
    ...
    race: loadJSON('../json/race.json').name,
    class: loadJSON('../json/class.json').name,
    ...
    skills: loadJSON('../json/skills.json').skills,
    inventory: loadJSON('../json/inventory.json').items
  };
